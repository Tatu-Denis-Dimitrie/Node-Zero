...
/// <summary>
/// Configurație centralizată pentru parametrii jocului
/// </summary>
struct GameConfig
{
    // Dimensiuni ecran
    ...
    static constexpr float PLAYER_ROTATION_SPEED = 360.0f; // grade/secundă

    // Configurare Node (Enemy)
    ...
    static constexpr float NODE_SPAWN_INTERVAL = 2.0f; // secunde
