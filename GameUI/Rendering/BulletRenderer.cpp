...
void BulletRenderer::DrawBullet(float x, float y, float size, float rotationDegrees, Color color)
{
    float rotation = rotationDegrees * DEG2RAD;
    
    Vector2 point1 = { 0.0f, -size };
    Vector2 point2 = { -size * 0.5f, size * 0.5f };
    Vector2 point3 = { size * 0.5f, size * 0.5f };
